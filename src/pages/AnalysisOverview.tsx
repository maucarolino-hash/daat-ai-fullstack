import { TrendingUp, Grid3X3, Activity, Swords } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Button onClick={() => setBattleModeOpen(true)} variant="neon" className="gap-2 self-start sm:self-auto text-base px-6 py-3">
