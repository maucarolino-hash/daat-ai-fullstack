...
const riskTags = ["CAC Alto", "Retenção", "Risco de Churn", "Guerra de Preços"];

export function RiskCard() {
  return (
    <div className="glass-card p-5 border-neon-orange/30">
      <div className="flex items-start justify-between mb-4">
        <span className="text-sm text-muted-foreground font-medium">Risco Detectado</span>
      ...
      <div className="flex items-center gap-2 mb-4">
        <span className="text-2xl font-bold text-neon-orange">Moderado</span>
